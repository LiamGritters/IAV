...
#ifndef __iav_lcm_lidar_t_hpp__
#define __iav_lcm_lidar_t_hpp__
...
int lidar_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->fov, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int lidar_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->fov, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
{
    uint64_t hash = 0x4b83f4119e03c148LL;
